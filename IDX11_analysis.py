...
# this first section is for the 8_4_2026_Redo_front
for i in range (15, 35, 5):
    INPUT_FOLDER = Path(f"NURBS IDX11/8_4_2026_Redo_front/{i}gps")
    OUTPUT_FOLDER = Path(f"NURBS IDX11 PYTHON ANALYSIS/8_4_2026_Redo_front/{i}gps")
...
for i in range (15, 35, 5):
    INPUT_FOLDER = Path(f"NURBS IDX11/Final/back/{i}gps")
    OUTPUT_FOLDER = Path(f"NURBS IDX11 PYTHON ANALYSIS/Final/back/{i}gps")
    OUTPUT_FOLDER.mkdir(parents=True, exist_ok=True)
...
for i in range (15, 35, 5):
    ...
    OUTPUT_FOLDER = Path(f"NURBS IDX11 PYTHON ANALYSIS/Final/front/{i}gps")
    OUTPUT_FOLDER.mkdir(parents=True, exist_ok=True)
